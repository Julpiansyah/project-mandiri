            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="card shadow-lg border-0 rounded-4" style="background: linear-gradient(135deg, #db2777, #3b82f6);">
                    <div class="card-body p-5">
                        <h2 class="text-center text-white mb-4 fw-bold">Login to Goers</h2>
                        ...
                        <form method="POST" action="{{ route('login.auth') }}">
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                <input type="email" id="form2Example1" class="form-control form-control-lg rounded-pill @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required />
                            ...
                            <!-- Password Input -->
                            <div data-mdb-input-init class="form-outline mb-4">
                                <input type="password" id="form2Example2" class="form-control form-control-lg rounded-pill @error('password') is-invalid @enderror" name="password" required />
                            ...
                            <!-- Submit Button -->
                            <button data-mdb-ripple-init type="submit" class="btn btn-warning btn-lg btn-block rounded-pill mb-4 fw-bold">Sign In</button>

                            <!-- Register and Social Login -->
                            <div class="text-center text-white">
                                <p>Not a member? <a href="{{ route('sign_up') }}" class="text-warning fw-bold text-decoration-underline">Register</a></p>
                                <p>or sign in with:</p>
